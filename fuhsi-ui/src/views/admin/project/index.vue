<template>
  <div>
    <div class="app-container">
      <div class="table-out-title"> {{ $t('page.admin.deploy.projectList') }}<span class="tail"/></div>
...
import apiAdminProject from '@/api/admin/project'
...
export default {
  ...
  methods: {
    getList() {
      ...
      apiAdminProject.list().then(response => {
